# Stability change report for package `WGLMakie`
...
### Signature `Tuple{typeof(WGLMakie.serialize_scene), Scene}`
...
### Signature `Tuple{typeof(WGLMakie.pick_native), WGLMakie.Screen, GeometryBasics.HyperRectangle{2, Int64}}`
